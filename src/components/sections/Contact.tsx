                    ...
                    >
                        {isSubmitted ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <motion.button
                                    type="submit"
                                    className="w-full py-4 bg-gray-900 text-white font-semibold rounded-full hover:bg-gray-800 transition-all flex items-center justify-center gap-2 shadow-lg"
