...
/* ?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•??
   ...
   Monolith-slab form Â· Code-shard BG Â· Flow-lines
   Two-column: info left, glass form right
   ?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•??*/

const FEATURES = [
    { icon: "school", title: "?Œìˆ˜ ?•ì˜ˆ êµìœ¡", desc: "?™ìƒ ê°œì¸ ë§ì¶¤??1:1 ë°€ì°?ì§€?„ë¡œ ?•ì‹¤???¤ë ¥ ?¥ìƒ??ë³´ì¥?©ë‹ˆ??" },
    { icon: "code", title: "?¤ì „ ì½”ë”© ?˜ì—…", desc: "C, Python, ?¹ê°œë°????¤ë¬´ ì¤‘ì‹¬ ì»¤ë¦¬?˜ëŸ¼?¼ë¡œ ë°”ë¡œ ?¨ë¨¹?????ˆëŠ” ì½”ë”©??ë°°ì›?ˆë‹¤." },
    { icon: "emoji_events", title: "?€?ŒÂ·ìê²©ì¦ ?€ë¹?, desc: "?•ë³´?¬ë¦¼?¼ì•„?? COS-Pro ??ëª©í‘œ??ë§ëŠ” ?¹í™” ?„ë¡œê·¸ë¨???´ì˜?©ë‹ˆ??" },
];

const INTERESTS = ["Python", "C/C++", "?¹ê°œë°?, "AIÂ·ë¨¸ì‹ ?¬ë‹"];
                ...
                <div className="ct-grid">
                    ...
                    >
                        ...
                        <div className="ct-proto-badge">
                            ...
                            <span className="ct-proto-text">ë¬´ë£Œ ?ë‹´ ?‘ìˆ˜</span>
                        </div>
                        <h2 className="ct-main-title">
                            <span className="ct-title-dark">ì½”ë”© ?ë‹´</span>
                            <span className="ct-title-metallic">? ì²­?˜ê¸°</span>
                        </h2>
                        <p className="ct-main-desc">
                            ?„ì§ IT ?„ë¬¸ê°€ê°€ ì§ì ‘ ?ë‹´?´ë“œë¦½ë‹ˆ?? ?„ì´???˜ì?ê³?ëª©í‘œ??ë§ëŠ” ìµœì ???™ìŠµ ë°©í–¥???ˆë‚´?©ë‹ˆ??
                        </p>
                    ...
                    >
                        ...
                        <div className="ct-slab">
                            ...
                            <div className="ct-form-header">
                                <h3 className="ct-form-title">?ë‹´ ? ì²­</h3>
                                <p className="ct-form-sub">?„ë˜ ?•ë³´ë¥??…ë ¥?˜ì‹œë©?ë¹ ë¥´ê²??°ë½?œë¦¬ê² ìŠµ?ˆë‹¤.</p>
                            </div>

                            <form className="ct-form" onSubmit={e => e.preventDefault()}>
                                <div className="ct-form-grid">
                                    <div className="ct-field group">
                                        <label className="ct-label">?´ë¦„</label>
                                        <div className="ct-slot">
                                            <input type="text" placeholder="?´ë¦„" className="ct-input" />
                                        </div>
                                    </div>
                                    <div className="ct-field group">
                                        <label className="ct-label">?°ë½ì²?/label>
                                        <div className="ct-slot">
                                ...
                                <div className="ct-field group">
                                    ...
                                    <div className="ct-slot ct-select-wrap">
                                        <select className="ct-input ct-select">
                                            <option disabled selected value="">?™ë…„ ? íƒ</option>
                                            <option>ì´ˆë“±?™ìƒ (1~3?™ë…„)</option>
                                            <option>ì´ˆë“±?™ìƒ (4~6?™ë…„)</option>
                                            <option>ì¤‘í•™??/option>
                                            <option>ê³ ë“±?™ìƒ</option>
                                            <option>?±ì¸</option>
                                        </select>
                                ...
                                <div className="ct-field">
                                    <label className="ct-label">ê´€??ê³¼ëª©</label>
