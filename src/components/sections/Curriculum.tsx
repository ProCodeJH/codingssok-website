...
const cards = [
    {
        ...
        title: "Math & Fusion", titleKr: "?¬ê³ ???˜í•™",
        desc: "ì½”ë”©?¼ë¡œ ?˜í•™ ê°œë…??ì§ì ‘ êµ¬í˜„?˜ë©° ë¬¸ì œ?´ê²°???ë¦¬ë¥?ê¹¨ìš°ì¹©ë‹ˆ??",
        skills: "?°ì‚° ?ë™??Â· ?¨í„´ ?¸ì‹ Â· ë¬¸ì œ ë¶„í•´ Â· ?˜ì—´ ?êµ¬ Â· ?„í˜• ì½”ë”©",
        skill: "?˜í•™ Ã— ì½”ë”© ?µí•©", skillIcon: "psychology",
        age: "ì´ˆë“± 1~4?™ë…„ Â· 1:4 ?Œìˆ˜?•ì˜ˆ", ageIcon: "school",
        schedule: "ì£?2??90ë¶?,
    ...
    },
    {
        ...
        title: "Software Master", titleKr: "?Œí”„?¸ì›¨??,
        desc: "Scratch ë¸”ë¡ì½”ë”©?¼ë¡œ ?¬ê³ ?¥ì„ ê¸°ë¥¸ ?? ?Œì´??·C?¸ì–´ë¡??ìŠ¤??ì½”ë”©??ì§„ì…?©ë‹ˆ??",
        skills: "?Œì´??Â· C?¸ì–´ Â· ?ë£Œêµ¬ì¡° Â· ?Œê³ ë¦¬ì¦˜ ?¤ê³„ Â· ?”ë²„ê¹?,
        skill: "ë¸”ë¡ ???ìŠ¤??ì½”ë”©", skillIcon: "code",
        age: "ì´ˆë“± 3~ì¤‘ë“± Â· 1:6 ë°€ì°?ì½”ì¹­", ageIcon: "school",
        schedule: "ì£?2??90ë¶?,
    ...
    },
    {
        ...
        title: "Arduino / IoT", titleKr: "?˜ë“œ?¨ì–´",
        desc: "LEDë¶€???¼ì„œ, ?œë³´ëª¨í„° ?œì–´ê¹Œì?. ì½”ë“œê°€ ?¤ì œ ?¥ì¹˜ë¥??€ì§ì´??ê²½í—˜??? ì‚¬?©ë‹ˆ??",
        skills: "?„ë‘?´ë…¸ Â· ?„ì ?Œë¡œ Â· ?¼ì„œ ?œìš© Â· IoT Â· 3D ?„ë¦°??,
        skill: "?¼ì?ì»?ì»´í“¨??, skillIcon: "developer_board",
        age: "ì´ˆë“± 3?™ë…„+ Â· 1:4 ?¤ìŠµ ì¤‘ì‹¬", ageIcon: "engineering",
        schedule: "ì£?1~2??90ë¶?,
    ...
    },
    {
        ...
        title: "Creation Studio", titleKr: "?„ë¡œ?íŠ¸",
        desc: "ê¸°íš?????€?´ì–´?„ë ˆ????ê°œë°œ ???ŒìŠ¤????ë°œí‘œ. ?¤ì œ ê°œë°œ ?„ë¡œ?¸ìŠ¤ë¥?ê²½í—˜?©ë‹ˆ??",
        skills: "??ê°œë°œ Â· ê²Œì„ ?œì‘ Â· UI/UX ?¤ê³„ Â· ?„ë ˆ? í…Œ?´ì…˜ Â· ?€ ?‘ì—…",
        skill: "ì°½ì‘ ?¤íŠœ?”ì˜¤", skillIcon: "rocket_launch",
        age: "?„ì—°??Â· 1:2~4 ?€", ageIcon: "groups",
        schedule: "ë§ì¶¤ ?¼ì •",
    ...
    },
    {
        ...
        title: "Pro Certification", titleKr: "?ê²©ì¦?,
        desc: "?œí—˜ ? í˜•ë³?ì§‘ì¤‘ ?™ìŠµê³??¤ì „ ëª¨ì˜ê³ ì‚¬ë¡??©ê²©ë¥ ì„ ê·¹ë??”í•©?ˆë‹¤.",
        skills: "COS-Pro Â· PCCE Â· ?•ë³´?¬ë¦¼?¼ì•„??Â· ?„ë¡œê·¸ë˜ë°ê¸°?¥ì‚¬ Â· ì»´í™œ",
        skill: "ëª©í‘œ ?¬ì„± ?¸ë™", skillIcon: "workspace_premium",
        age: "ì¤?ê³ ë“± Â· 1:4 ì§‘ì¤‘ ì½”ì¹­", ageIcon: "school",
        schedule: "?œí—˜ ë§ì¶¤ ?¼ì •",
                ...
                <div className="container-nod" style={{ position: "relative", zIndex: 10 }}>
                    ...
                    <header className="holo-header">
                        ...
                        <p className="holo-desc">
                            5?¨ê³„ ë§ˆìŠ¤?°ë¦¬ ê³¼ì •???µí•´ ì²´ê³„?ìœ¼ë¡??±ì¥?˜ì„¸?? ê°??¨ê³„ë¥??´ë¦­?˜ë©´ ?ì„¸ ì»¤ë¦¬?˜ëŸ¼???•ì¸?????ˆìŠµ?ˆë‹¤.
                        </p>
                    </header>
