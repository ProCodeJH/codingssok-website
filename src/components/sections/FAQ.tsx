        ...
        <section id="faq" className="py-32 bg-gray-50">
            <div className="max-w-7xl mx-auto px-8 lg:px-12">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
                    ...
                    >
                        <span className="px-4 py-2 bg-gray-200 text-gray-700 text-sm font-semibold rounded-full inline-block mb-6">
                            FAQ
                        </span>
                        ...
                        <motion.a
                            href="#contact"
                            className="inline-flex items-center gap-2 px-8 py-4 border-2 border-gray-900 text-gray-900 font-medium rounded-full hover:bg-gray-900 hover:text-white transition-all"
