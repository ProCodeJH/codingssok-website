...
.fq-header-icon { display: inline-flex; width: 64px; height: 64px; border-radius: 16px; background: rgba(255,255,255,0.4); backdrop-filter: blur(16px); border: 1px solid rgba(255,255,255,0.6); align-items: center; justify-content: center; color: #5A8BBB; margin-bottom: 24px; box-shadow: 0 8px 32px rgba(31,38,135,0.1); }
