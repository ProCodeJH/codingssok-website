            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto px-8">
                ...
                <div className="space-y-4">
                    {faqs.map((faq, i) => (
                        ...
                        >
                            <div className={`relative bg-white/80 backdrop-blur-xl rounded-2xl border-2 overflow-hidden transition-all duration-300 ${
                                openIndex === i
                                ...
                                {openIndex === i && (
                                    <motion.div
                                        initial={{ scaleX: 0 }}
                                        animate={{ scaleX: 1 }}
                                        className="h-1 bg-gradient-to-r from-blue-600 to-cyan-500 origin-left"
                                    />
                                )}
                                <button
                                    onClick={() => setOpenIndex(openIndex === i ? null : i)}
                                    className={`w-full flex items-center justify-between p-6 text-left transition-colors ${
                                        openIndex === i ? 'bg-gradient-to-r from-blue-50/50 to-cyan-50/50' : 'hover:bg-gray-50/50'
                                    }`}
                                >
                                    <div className="flex items-center gap-4">
                                        <motion.span
                                            ...
                                            animate={openIndex === i ? { scale: [1, 1.1, 1] } : {}}
                                    ...
                                    <motion.div
                                        ...
                                        className={`flex-shrink-0 ml-4 w-10 h-10 rounded-xl flex items-center justify-center transition-colors ${
                                            openIndex === i ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-400'
                                        }`}
                                    >
                                        <ChevronDown size={20} />
                                    </motion.div>
                                    ...
                                    {openIndex === i && (
                                        ...
                                        >
                                            <div className="px-6 pb-6 pt-2">
                                                <div className="pl-14 border-l-2 border-blue-300 ml-1">
