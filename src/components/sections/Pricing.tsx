                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    {plans.map((plan, i) => (
                        ...
                        >
                            ...
                            {/* 카드 글로우 */}
                            {plan.popular && (
                                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-3xl blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-500 translate-y-4" />
                            )}
