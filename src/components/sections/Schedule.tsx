...
const steps = [
    {
        num: "01", code: "PAYMENT", title: "Í≤∞Ï†ú ?ÑÎ£å",
        desc: "Îß§Ïõî 1???úÏä§???êÎèô Í≤∞Ï†ú Ï≤òÎ¶¨.",
    ...
    {
        num: "02", code: "FORM", title: "???òÏã†",
        desc: "?§Ï?Ï§??§Ï†ï Íµ¨Í? ???êÎèô Î∞úÏÜ°.",
    ...
    {
        num: "03", code: "SYNC", title: "?úÍ∞Ñ???ïÏ†ï",
        desc: "ÏµúÏ†Å?îÎêú ÎßûÏ∂§ ?úÍ∞Ñ???êÎèô Î∞∞Ïπò.",
                ...
                <div className="container-nod fls-main">
                    ...
                    <div className="fls-header">
                        ...
                        <h1 className="fls-title">
                            ...
                            ?ÑÏù¥???§Ï?Ï§ÑÏóê<br />
                            <span className="fls-title-accent">ÍµêÏú°??ÎßûÏ∂•?àÎã§</span>
                        </h1>
                        ...
                        <div className="fls-info-content">
                            ...
                            <div className="fls-info-text">
                                <div className="fls-info-title-row">
                                    <h2 className="fls-info-title">?ÑÏö© Íµ¨Í? ???§Ï?Ï§ÑÎßÅ</h2>
                                    <span className="fls-info-badge">Auto-Form v1.2</span>
                                </div>
                                <p className="fls-info-desc">Îß§Ïõî 1??Í≤∞Ï†ú ??Î∞úÏÜ°?òÎäî ?ÑÏö© Íµ¨Í? ?ºÏùÑ ?µÌï¥, ?ÑÏù¥???òÍµê ?úÍ∞ÑÍ≥??Ä ?ôÏõê ?ºÏ†ï??ÏµúÏ†Å?îÎêú ?úÍ∞Ñ?úÎ? ÏßÅÏ†ë ?§Í≥Ñ?òÏÑ∏??</p>
                            </div>
