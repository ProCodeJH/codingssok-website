...
export default function Services() {
    return (
        <>
            {/* Quote */}
            <section className="w-full bg-gray-900 flex justify-center" style={{ paddingTop: '200px', paddingBottom: '200px' }}>
            ...
            {/* Services */}
            <section id="services" className="w-full bg-gray-50 flex justify-center" style={{ paddingTop: '200px', paddingBottom: '200px' }}>
