                ...
                <div className="w-full max-w-5xl mx-auto px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {services.map((service, i) => (
                            ...
                            >
                                <div className="w-14 h-14 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-500/30">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ delay: i * 0.1 }}
                                className="aspect-[4/3] relative rounded-2xl overflow-hidden bg-gray-100 border border-gray-200 shadow-sm hover:shadow-xl hover:shadow-blue-500/10 transition-all"
                            >
                                <Image
                                    src={img.src}
                                    alt={img.alt}
