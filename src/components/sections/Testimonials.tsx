...
export default function Testimonials() {
    ...
    return (
        <section ref={ref} id="testimonials" className="ts-section">
            <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@500;700;900&family=Pretendard:wght@300;400;500;600;700;800&display=swap" rel="stylesheet" />
...
.ts-live-badge { display: inline-flex; align-items: center; gap: 8px; padding: 6px 18px; border-radius: 999px; background: rgba(255,255,255,0.4); backdrop-filter: blur(16px); border: 1px solid rgba(255,255,255,0.6); font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.2em; color: #312e81; margin-bottom: 24px; box-shadow: 0 4px 16px rgba(0,0,0,0.04); animation: tsPulseGlow 4s ease-in-out infinite; font-family: 'Orbitron', sans-serif; }
...
.ts-achieve-box { display: flex; align-items: center; gap: 12px; padding: 14px 16px; border-radius: 12px; background: rgba(255,255,255,0.4); backdrop-filter: blur(16px); border: 1px solid rgba(255,255,255,0.5); box-shadow: inset 0 0 10px rgba(255,255,255,0.2); margin-bottom: 16px; }
