...
/* ?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•??
   ?˜ê°•???±ê³µ ?¤í† ë¦???Quantum Nexus Slider
   Aero-glass cards Â· Horizontal Scroll Â· 3D tilt
   ?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•??*/
...
const STORIES = [
    {
        ...
        stars: 1,
        quote: "ì²˜ìŒ???€?´í•‘???˜ë“¤?´í–ˆì§€ë§? 3ê°œì›” ë§Œì— êµ¬êµ¬???Œê³ ë¦¬ì¦˜???¤ìŠ¤ë¡??¤ê³„?ˆìŠµ?ˆë‹¤. ?¼ë¦¬???¬ê³ ???•ì¥???ˆì— ë³´ì…?ˆë‹¤.",
        highlight: "êµ¬êµ¬???Œê³ ë¦¬ì¦˜",
    ...
    },
    {
        ...
        stars: 2,
        quote: "?˜í•™???¬ê¸°?˜ë ¤???„ì´ê°€ ì½”ë”© ë³€?˜ë? ë°°ìš°ë©??¨ìˆ˜ ê°œë…???„ë²½???´í•´?ˆìŠµ?ˆë‹¤. êµê³¼ ?±ì ê¹Œì? ?˜ì§ ?ìŠ¹?ˆì–´??",
        highlight: "?¨ìˆ˜ ê°œë…",
    ...
    },
    {
        ...
        stars: 1,
        quote: "?€?™ë…„?´ë¼ ê±±ì •?ˆëŠ”?? ë¸”ë¡ì½”ë”©??ê²Œì„ì²˜ëŸ¼ ì¦ê²¨?? ë§¤ì£¼ ?¤ëŠ” AI ë¶„ì„ ë¦¬í¬?¸ë¡œ ?„ì´??ê´€?¬ì‚¬ë¥??•í™•???Œì•…?ˆìŠµ?ˆë‹¤.",
        highlight: "AI ë¶„ì„ ë¦¬í¬??,
        ...
        achievement: "ì°½ì‘ ê²Œì„ 3ì¢?ì¶œì‹œ",
    ...
    },
    {
        ...
        stars: 3,
        quote: "?™ì›?ì„œ ë§Œë“  ?¬íŠ¸?´ë¦¬?¤ë¡œ ?™êµ ë°œí‘œ???€?ì„ ë°›ì•˜?´ìš”. ?€?¤íƒ ê°œë°œ?ë¼??êµ¬ì²´?ì¸ ê¿ˆì„ ê°€ì§€ê²??˜ì—ˆ?µë‹ˆ??",
        highlight: "?€?¤íƒ ê°œë°œ??,
